...
class Users extends CI_Controller {
	...
	{
		$ceks = $this->session->userdata('surat_arsip@Proyek-2021');
		$id_user = $this->session->userdata('id_user@Proyek-2021');
		if(!isset($ceks)) {
			redirect('web/login');
		}else{
			$data['user']   	 = $this->Mcrud->get_users_by_un($ceks);
			$data['users']  	 = $this->Mcrud->get_users();
			$data['judul_web'] = "Beranda | Aplikasi Arsip Surat";
	...
	public function profile()
	{
		...
		if(!isset($ceks)) {
			...
			$data['judul_web'] 		= "Profile | Aplikasi Arsip Surat";
		...
		if(!isset($ceks)) {
			...
			$data['level_users']  = $this->Mcrud->get_level_users();
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Pengguna | Aplikasi Arsip Surat";
				}elseif ($aksi == 'd') {
					$p = "pengguna_detail";

					$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
					$data['judul_web'] 	  = "Detail Pengguna | Aplikasi Arsip Surat";
				}elseif ($aksi == 'e') {
					$p = "pengguna_edit";

					$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
					$data['judul_web'] 	  = "Edit Pengguna | Aplikasi Arsip Surat";
				}elseif ($aksi == 'h') {

					$data['query'] = $this->db->get_where("tbl_user", "id_user = '$id'")->row();
					$data['judul_web'] 	  = "Hapus Pengguna | Aplikasi Arsip Surat";
					...
					$data['judul_web'] 	  = "Pengguna | Aplikasi Arsip Surat";
				}
		...
		if(!isset($ceks)) {
			...
			$data['bagian'] 		  = $this->db->get("tbl_bagian");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Bagian | Aplikasi Arsip Surat";
				}elseif ($aksi == 'e') {
					$p = "bagian_edit";
					if ($data['user']->row()->level == 's_admin') {
							redirect('404_content');
					...
					$data['judul_web'] 	  = "Edit Bagian | Aplikasi Arsip Surat";
					...
					$data['query'] = $this->db->get_where("tbl_bagian", array('id_bagian' => "$id"))->row();
					$data['judul_web'] 	  = "Hapus Bagian | Aplikasi Arsip Surat";
					...
					$data['judul_web'] 	  = "Bagian | Aplikasi Arsip Surat";
				}
		...
		if(!isset($ceks)) {
			...
			$data['ns'] 		  = $this->db->get("tbl_ns");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Nomor Surat | Aplikasi Arsip Surat";
				}elseif ($aksi == 'e') {
					$p = "ns_edit";
					if ($data['user']->row()->level == 's_admin') {
							redirect('404_content');
					...
					$data['judul_web'] 	  = "Edit Nomor Surat | Aplikasi Arsip Surat";
					...
					$data['query'] = $this->db->get_where("tbl_ns", array('id_ns' => "$id", 'id_user' => "$id_user"))->row();
					$data['judul_web'] 	  = "Hapus Nomor Surat | Aplikasi Arsip Surat";
					...
					$data['judul_web'] 	  = "Nomor surat | Aplikasi Arsip Surat";
				}
		...
		if(!isset($ceks)) {
			...
			$data['sm'] 		  = $this->db->get("tbl_sm");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Surat Masuk | Aplikasi Arsip Surat";
					$data['data_ns']			= $this->Mcrud->data_ns('sm', "$id_user");
				}elseif ($aksi == 'd') {
					$p = "sm_detail";

					$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id"))->row();
					$data['judul_web'] 	  = "Detail Surat Masuk | Aplikasi Arsip Surat";
					...
					$data['query'] = $this->db->get_where("tbl_sm", array('id_sm' => "$id"))->row();
					$data['judul_web'] 	  = "Edit Surat Masuk | Aplikasi Arsip Surat";
					...
					$data['judul_web'] 	  = "Hapus Surat Masuk | Aplikasi Arsip Surat";
					...
					$data['judul_web'] 	  = "Surat Masuk | Aplikasi Arsip Surat";
				}
		...
		if(!isset($ceks)) {
			...
			$data['bagian'] 		  = $this->db->get_where("tbl_bagian","id_user='$id_user'")->result();
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Surat Keluar | Aplikasi Arsip Surat";
					...
					$data['judul_web'] 	  = "Detail Surat Keluar | Aplikasi Arsip Surat";
					...
					$data['judul_web'] 	  = "Edit Surat Keluar | Aplikasi Arsip Surat";
					...
					$data['query'] = $this->db->get_where("tbl_sk", array('id_sk' => "$id", 'id_user' => "$id_user"))->row();
					$data['judul_web'] 	  = "Hapus Surat Keluar | Aplikasi Arsip Surat";
					...
					$data['judul_web'] 	  = "Surat Keluar | Aplikasi Arsip Surat";
				}
		...
		if(!isset($ceks)) {
			...
			$data['memo'] 		  = $this->db->get("tbl_memo");
				...
				if ($aksi == 't') {
					...
					$data['judul_web'] 	  = "Tambah Memo | Aplikasi Arsip Surat";
				}elseif ($aksi == 'e') {
					$p = "memo_edit";
					if ($data['user']->row()->level == 's_admin') {
							redirect('404_content');
					...
					$data['judul_web'] 	  = "Edit Memo | Aplikasi Arsip Surat";
					...
					$data['query'] = $this->db->get_where("tbl_memo", array('id_memo' => "$id", 'id_user' => "$id_user"))->row();
					$data['judul_web'] 	  = "Hapus Memo | Aplikasi Arsip Surat";
					...
					$data['judul_web'] 	  = "Memo | Aplikasi Arsip Surat";
				}
	...
	public function lap_sk()
	{
		...
		if(!isset($ceks)) {
			...
			$data['user']  			    = $this->Mcrud->get_users_by_un($ceks);
			$data['judul_web']			= "Laporan Surat Keluar | Aplikasi Arsip Surat";
			...
			if(!isset($ceks)) {
				redirect('web/login');
						...
						if ($tgl1 != '' AND $tgl2 != '') {
								...
								$data['user']  		 = $this->Mcrud->get_users_by_un($ceks);
								$data['judul_web'] = "Data Laporan Surat Keluar | Aplikasi Arsip Surat";
								$this->load->view('users/header', $data);
	...
	public function lap_sm()
	{
		...
		if(!isset($ceks)) {
			...
			$data['user']  			    = $this->Mcrud->get_users_by_un($ceks);
			$data['judul_web']			= "Laporan Surat Masuk | Aplikasi Arsip Surat";
			...
			if(!isset($ceks)) {
				redirect('web/login');
						...
						if ($tgl1 != '' AND $tgl2 != '') {
								...
								$data['user']  		 = $this->Mcrud->get_users_by_un($ceks);
								$data['judul_web'] = "Data Laporan Surat Masuk | Aplikasi Arsip Surat";
								$this->load->view('users/header', $data);
