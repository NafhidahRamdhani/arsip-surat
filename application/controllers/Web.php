...
class Web extends CI_Controller {
								 ...
								 redirect('web/login');
										 ...
										 if($cekpass <> $pass) {
												...
												redirect('web/login');
																...
																$this->session->set_userdata('surat_arsip@Proyek-2021', "$cekun");
																$this->session->set_userdata('id_user@Proyek-2021', "$row->id_user");
	...
	public function logout() {
     if ($this->session->has_userdata('surat_arsip@Proyek-2021') and $this->session->has_userdata('id_user@Proyek-2021')) {
