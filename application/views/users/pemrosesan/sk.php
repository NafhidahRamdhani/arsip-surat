            ...
            <ul class="icons-list">
              <li><a data-action="collapse"></a></li>
                ...
                if ($user->row()->level == 'user') { ?>
                    <br>
                    <a href="users/sk/t" class="btn btn-danger"></i> Arsipkan Surat</a>
                <?php
                } ?>
        </div>
              ...
              ?>
                <tr <?php if($baris->peringatan == 1){echo 'style="background:yellow;"';} ?>>
                  ...
                  <td>
                    ...
                    <?php
                    if ($user->row()->level == 'user') { ?>
                    <a href="users/sk/e/<?php echo $baris->id_sk; ?>" class="btn btn-danger btn-xs"><i class=Unduh>Unduh</i></a>
                    <a href="users/sk/h/<?php echo $baris->id_sk; ?>" class="btn btn-warning btn-xs" onclick="return confirm('Apakah Anda yakin?')"><i class="icon-trash"></i></a>
                    <?php
                    } ?>
                  </td>
                </tr>
